    ...
    <div class="list closed">
        <ul>
          <!------>
            ...
            <li><a rel="nofollow" href="https://www.netflix.com/" target="_blank"><svg class="icon" aria-hidden="true"><use xlink:href="#icon-netflix"></use></svg>奈非影视</a></li>
